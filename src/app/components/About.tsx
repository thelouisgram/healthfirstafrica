...
export default function AboutUs() {
  return (
    <section id="about" className="relative bg-[#F9F5EF] py-20 px-4 md:px-8 lg:px-16 overflow-hidden">
      {/* Background Logo */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10">
        <Image 
          src="/assets/logo.png" // make sure this path matches your public folder setup
