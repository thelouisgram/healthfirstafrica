    ...
    <section className="bg-[#F9F5EF] py-20 px-4 md:px-8 lg:px-16">
      ...
      >
        ...
        <p className="text-[#1F1F1F] text-lg leading-relaxed mt-6">
          ...
          comprehensive, people-centered healthcare services, advancing health
          education, and addressing health disparities through community-based
          and culturally relevant approaches. We empower individuals—especially
          women, adolescents, and young people—with the tools, knowledge, and
          opportunities to lead healthy and productive lives.
        </p>
        ...
        <p className="text-[#1F1F1F] text-lg leading-relaxed mt-6">
          ...
          stigma, and foster economic independence among vulnerable groups. At
          the core of our mission is the belief that sustainable development
          begins with health equity, empowerment, and dignity for all.
        </p>
      </motion.div>
    </section>
  );
